...
requeteCreationClass = "create table class (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,className varchar(255) unique NOT NULL, numberOfMachines integer , numberOfNetwork INTEGER);"


#exécution des requetes
cursor.execute(requeteCreationUser)
cursor.execute(requeteCreationClass)
cursor.execute("insert into class (className,numberOfMachines,numberOfNetwork) values ('A',126,16777214),('B',16384,65534),('C',2097152,256),('D',0,0),('E',0,0),('Réservées',0,0);")
